...
class SIGLIPV2Config:
    def __init__(self) -> None:
        ...
        self.SIGLIP_V2_CUDA_VISIBLE_DEVICES = os.getenv("SIGLIP_V2_CUDA_VISIBLE_DEVICES", "2")

        self.SIGLIP_V2_QDRANT_URL = os.getenv("SIGLIP_V2_QDRANT_URL")
        self.SIGLIP_V2_QDRANT_PORT = int(os.getenv("SIGLIP_V2_QDRANT_PORT"))
        self.SIGLIP_V2_QDRANT_GRPC_PORT = int(os.getenv("SIGLIP_V2_QDRANT_GRPC_PORT"))

        self.SIGLIP_V2_DATABASE_NAME = os.getenv("SIGLIP_V2_DATABASE_NAME")
        assert self.SIGLIP_V2_DATABASE_NAME, "Environment variable 'SIGLIP_V2_DATABASE_NAME' must be set"

        features_path_env = os.getenv("SIGLIP_V2_FEATURES_PATH")
        assert features_path_env, "Environment variable 'SIGLIP_V2_FEATURES_PATH' must be set"
        try:
            self.SIGLIP_V2_FEATURES_PATH: List[str] = ast.literal_eval(features_path_env)
        except Exception as e:
            raise ValueError(f"Invalid list format for SIGLIP_V2_FEATURES_PATH: {features_path_env}") from e
        ...
        assert self.SIGLIP_V2_DUMMY_VECTOR_PATH, "Environment variable 'SIGLIP_V2_DUMMY_VECTOR_PATH' must be set"
